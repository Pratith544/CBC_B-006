    ...
    <PageContainer>
      <div className="py-10 md:py-16">
        ...
        <div className="mt-8 bg-gray-50 dark:bg-gray-800 p-4 rounded-lg text-sm text-gray-600 dark:text-gray-400">
          <p>
            Your information is used only to generate personalized
            recommendations and is not shared with third parties. The more
            details you provide, the more accurate your recommendations will be.
          </p>
        </div>
      </div>
    </PageContainer>
