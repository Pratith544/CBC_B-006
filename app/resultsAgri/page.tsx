...
const mockRecommendations: RecommendationResponse = {
  ...
  soilAnalysis: {
    ...
    improvement:
      "Consider adding organic matter like farmyard manure or compost to improve soil structure and water retention capacity. Crop rotation with legumes can help in nitrogen fixation.",
  },
  explanations: {
    primary:
      "These primary crops are recommended based on your soil type, water availability, and climate conditions. Rice, wheat, and maize are well-suited for your alluvial soil and have good market demand in your region.",
    secondary:
      "These alternative crops can be grown in rotation with primary crops to improve soil health and diversify income sources. They require less water and can be suitable during periods of water scarcity.",
  },
  resourceOptimization: [
    {
      title: "Water Management",
      description:
        "Implement drip irrigation for row crops to reduce water usage by up to 40%. For rice, consider Alternate Wetting and Drying (AWD) technique which can save 15-30% water without reducing yield.",
    },
    {
      title: "Fertilizer Efficiency",
      description:
        "Use split applications of fertilizers based on crop growth stages. For nitrogen, apply in 3-4 splits to reduce losses and improve uptake efficiency.",
    },
    {
      title: "Labor Optimization",
      description:
        "Consider mechanical transplanting for rice and mechanical sowing for wheat to reduce labor requirements during peak seasons.",
    },
    {
      title: "Integrated Pest Management",
      description:
        "Adopt IPM practices combining biological controls, crop rotation, and targeted pesticide application only when necessary to reduce costs and environmental impact.",
    },
  ],
  advancedTechniques: [
    {
      ...
      description:
        "Use soil testing and variable rate application of inputs based on soil fertility maps to optimize resource use. This can reduce input costs by 10-15% while maintaining or improving yields.",
      difficulty: "Medium",
    ...
    },
    {
      ...
      description:
        "Implement minimum tillage, permanent soil cover, and crop rotation to improve soil health, reduce erosion, and lower production costs.",
      difficulty: "Easy",
    ...
    },
    {
      ...
      description:
        "Adopt SRI methods for rice cultivation to increase yields by 20-50% while using less water, seeds, and chemical inputs.",
      difficulty: "Medium",
  ...
  yieldEstimates: [
    {
      ...
      factors:
        "Yield can be higher with proper water management, timely planting, and balanced nutrition. SRI methods can further increase yields.",
    },
    {
      crop: "Wheat",
      ...
      factors:
        "Timely sowing (first half of November), adequate irrigation at critical stages, and rust disease management are key to achieving higher yields.",
    },
    {
      crop: "Maize",
      ...
      factors:
        "Hybrid varieties, proper spacing, and protection from fall armyworm can help achieve higher yields.",
    },
  ],
};
      ...
      <PageContainer>
        <div className="min-h-[60vh] flex flex-col items-center justify-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-md text-center">
            We're analyzing your data and preparing personalized farming
  ...
  return (
    <PageContainer>
      <div className="py-10 md:py-16">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            ...
            <SectionHeading
              ...
              subtitle={
                farmerData
                  ? `Based on your data for ${farmerData.landInfo.soilType} soil in ${farmerData.personalInfo.location}`
                  : ""
              }
              className="mb-0"
            />
        ...
        <ResourceOptimization
          optimizations={recommendations.resourceOptimization}
        />
        ...
        <div className="mt-8 bg-green-50 dark:bg-green-900/20 p-6 rounded-xl border border-green-100 dark:border-green-900/30">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            These recommendations are based on the information you provided. For
            more detailed advice, consider consulting with local agricultural
            extension services or agronomy experts in your area.
          </p>
