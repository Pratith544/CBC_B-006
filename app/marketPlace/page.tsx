    ...
    <div className="min-h-screen bg-background">
      {showWelcome && (
        <div className="bg-accent text-accent-foreground p-4 relative">
          <div className="container mx-auto flex items-center">
            ...
            <div>
              <p className="text-lg">
                Welcome to the Local Marketplace! Find fresh produce and
                handcrafted items from local farmers and artisans.
              </p>
            </div>
            <button
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="space-y-6 mb-8">
          <section>
            ...
            <VoiceSearch
              ...
              placeholder="Search by product name, type, or seller..."
            />
          </section>
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <button className="flex items-center bg-primary text-primary-foreground px-6 py-3 rounded-lg text-lg font-medium hover:bg-primary/90 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Local Marketplace connects farmers and small businesses with
                customers in their community. Support local businesses and get
                fresh produce directly from the source.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Email: help@localmarket.com
              </p>
              <p className="text-muted-foreground">
                Address: 123 Market Street, Dehradun
              </p>
            </div>
